...
import { MCPTool, ToolResponse, MCPError, MCPServerConfig } from './types.js';
...
export class MCPServer {
   ...
   */
  private validateInput(input: any, schema: any): string | null {
   ...
   * Validate field type
   */
  private validateFieldType(value: any, schema: any, fieldName: string): string | null {
   ...
   */
  private createErrorResponse(code: string, message: string, details?: any): ToolResponse {
    return {
      content: [
        {
          type: 'text',
